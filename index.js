...
$(function() {
  ...
  /*
   * You will need to use a css selector to get jQuery to find the button element in the page
   ...
   */
  $("#animal").click(()=>fetchRandomTriviaQuestion(displayQuestionAndAnswer));
});
